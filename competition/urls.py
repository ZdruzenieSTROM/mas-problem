...
urlpatterns = [
    ...
    path('', flatpage, {'url': '/info/'}, name='info'),
    path('pravidla', flatpage, {'url': '/pravidla/'}, name='pravidla'),
    path('akosazapojit', flatpage, {'url': '/akosazapojit/'}, name='akosazapojit'),
    ...
    path('moj-diplom/<int:pk>',view=views.CompetitorCertificateView.as_view(),name='my-certificate'),
    ...
    path('umiestnenia',views.PlacementsView.as_view(),name='placements')
]
